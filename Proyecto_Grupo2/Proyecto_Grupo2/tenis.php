...
<head>
    ...
    <!--style tema -->
    <link rel="stylesheet" href="css/style_tenis.css">
    <!-- responsive-->
        ...
        <div id="content">
            ...
            <div class="slider_section banner_main">
                <div class="container">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main_text">
                                <?php echo '<h1>Academia <br><strong class="bold_text">Tenis</strong><br><strong class="bold_text_black">Santo Domingo</strong></h1>'; ?>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <article class="tenis">
                ...
                <div class="resumen-academia">
                    <p>
                        La academia de tenis Santo Domingo se dedica a formar jóvenes talentos en el deporte de la raqueta, ofreciendo un entorno seguro y motivador donde los niños y adolescentes pueden desarrollar sus habilidades tenísticas. Con entrenadores altamente calificados y una metodología de enseñanza moderna, garantizamos el crecimiento tanto personal como deportivo de nuestros estudiantes.
                    </p>
                    <p>
                        Nuestras instalaciones están equipadas con todo lo necesario para la práctica del tenis, incluyendo canchas de tenis de arcilla y de superficie dura, vestuarios, y áreas de descanso. Además, organizamos torneos y actividades complementarias para fomentar el trabajo en equipo y la competencia sana entre los participantes.
                    </p>
                </div>
